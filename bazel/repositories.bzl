...
def _gaia_net():
    maybe(
        http_archive,
        name = "gaia_net",
        strip_prefix = "gaia_net-gaia2.1",
        sha256 = "609584690bea2627929e3eba41871ba5355a9a6674feabfccc57a17d42d94db9",
        type = "tar.gz",
        urls = [
            "https://github.com/Yinbenxin/gaia_net/archive/refs/tags/gaia2.1.tar.gz",
        ],
    )